  ...
  reviews: {
    handler: function(request, reply) {
      ...
      if (request.query.location) {
        ...
        var patternAddress = new RegExp(location, 'i');
      ...
      searchYelp(terms, function(biz) {
        ...
        if (typeof biz.businesses !== 'undefined' && biz.businesses.length > 0) {
          ...
          if (request.query.phone) {
            ...
            businessPhone = _.findWhere(biz.businesses, {
              phone: phone
            });


            businessName = _.findWhere(biz.businesses, {
              name: term.latinize()
            });

            business = (typeof businessPhone !== 'undefined') ? businessPhone : businessName;
            ...
            if (typeof business !== 'undefined') {
              ...
              // next search on google
              searchGoogle(terms, function(id) {
                if (id !== 'no match') {
                  businessYelp(id, function(res) {
                    reply(res);
                  });
                } else {
                  reply({
